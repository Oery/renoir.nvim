...
if vim.o.background == 'light' then
	...
	colorscheme.editorBackground = config.transparent and 'none' or '#080808'
	colorscheme.sidebarBackground = config.transparent and 'none' or '#1a1a1a'
	colorscheme.popupBackground = '#292929'
	colorscheme.floatingWindowBackground = config.transparent and 'none' or '#080808'
	colorscheme.menuOptionBackground = '#282828'

	colorscheme.mainText = '#f7f1ff'
